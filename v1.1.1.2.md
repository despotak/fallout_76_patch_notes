...
- XCRP - Unknown AND XCPF - Unknown sub-records **removed** from a bunch of cells (**EdNote:** XCRP is (was) for precombined references. Evidence suggests that they were moved outside the .esm, for performance reasons)
...
- XCRP - Unknown AND XCPF - Unknown sub-records **removed** from all cells (**EdNote:** XCRP is (was) for precombined references. Evidence suggests that they were moved outside the .esm, for performance reasons)
