...
* [<em>Fallout 76</em> 11/12/18 Patch Notes](#fallout-76-111218-patch-notes)
   ...
   * [Community Patch notes](#community-patch-notes)
      * [Changes found on the "SeventySix.esm" file](#changes-found-on-the-seventysixesm-file)
         * [Workshops](#workshops)
            * [Extractor capacity](#extractor-capacity)
            * [Special Workshop capacity](#special-workshop-capacity)
            * [Resource Production rate](#resource-production-rate)
            * [Resource Production output](#resource-production-output)
         * [Stash](#stash)
